...
export function BoostingOrderCard({
  ...
  const toggleOptions = [
    {
      key: "stream",
      label: "Live Stream",
      description: "Watch your progress live",
    },
    {
      key: "offlineMode",
      label: "Offline Mode",
      description: "Appear offline to friends",
    },
    {
      key: "remoteParsec",
      label: "Remote Parsec",
      description: "Play via remote desktop",
    },
    {
      key: "useVPN",
      label: "VPN Protection",
      description: "Safe IP matching",
    },
    {
      key: "jagexAccount",
      label: "Jagex Account",
      description: "New account system support",
    },
  ] as const;
  ...
  const handleSubmit = async (): Promise<void> => {
    ...
    try {
      ...
      console.log(
        "Request submitted successfully, redirecting to:",
        `/marketplace/requests/${data.id}`
      );
      ...
      try {
        ...
        console.error(
          "Router redirect failed, falling back to window.location:",
          redirectError
        );
        ...
        <div className="space-y-5 mb-12">
          {toggleOptions.map((opt) => (
            ...
            >
              ...
              <button
                onClick={() =>
                  onOptionChange(opt.key, !options[opt.key as keyof typeof options])
                }
                className={cn(
              ...
              {summary.details.length > 0 ? (
                <div className="space-y-4 pl-10 border-l-2 border-zinc-800/50 ml-4">
                  {summary.details.map((detail, idx) => (
                    <div
                      key={idx}
                      className="flex items-start gap-3 group/detail relative"
                    >
