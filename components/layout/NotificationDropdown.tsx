      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="absolute top-full right-[-1rem] md:right-0 mt-4 w-[calc(100vw-2rem)] md:w-96 bg-zinc-950 border border-white/10 rounded-2xl shadow-[0_20px_50px_rgba(0,0,0,0.5)] overflow-hidden z-[60]"
          >
