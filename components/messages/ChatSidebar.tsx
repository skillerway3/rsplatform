      ...
      <header className="space-y-6">
        <div className="flex items-center justify-between">
          <div className="space-y-1">
            <div className="text-amber-500 text-[10px] font-black uppercase tracking-[0.4em]">
              Comms Hub
            </div>
            <h1 className="text-4xl font-black text-zinc-100 tracking-tighter uppercase">
              Messages
            </h1>
          </div>
          ...
          return (
            ...
            >
              <div className="relative shrink-0">
                ...
                {hasNew && (
                  <div className="absolute -top-1 -right-1 w-3 h-3 bg-amber-500 border-2 border-zinc-950 rounded-full" />
                )}
              </div>
              ...
              <div className="flex-1 min-w-0 space-y-1">
                <div className="flex items-center justify-between">
                  ...
                  <span className="text-[9px] font-black text-zinc-600 uppercase tracking-widest">
                    {lastAt ? formatDate(lastAt) : 'No Date'}
                  </span>
                </div>
