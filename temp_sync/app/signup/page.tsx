      ...
      <div className="flex-1 flex items-center justify-center p-6 relative z-10">
        <div className="w-full max-w-md space-y-12">
          ...
          <div className="space-y-4 text-center">
            <h1 className="text-5xl font-black text-zinc-100 tracking-tighter uppercase leading-none">Create Account</h1>
            <p className="text-zinc-500 text-[10px] font-black uppercase tracking-[0.3em]">Join the RSPlatform Marketplace</p>
          </div>
          ...
          <Card className="premium-card p-10 space-y-8">
            <form onSubmit={handleSignup} className="space-y-8">
              <div className="space-y-6">
                <Input 
                  label="Username" 
                  placeholder="e.g. ShadowMerchant"
                  required
                  value={username}
              ...
              <div className="flex items-start space-x-3">
                <input 
                  ...
                  className="mt-1 w-4 h-4 rounded border-zinc-800 bg-black/40 text-amber-500 focus:ring-amber-500/20"
                />
                <label htmlFor="terms" className="text-[9px] font-black text-zinc-500 uppercase tracking-widest leading-relaxed">
                  I acknowledge the <Link href="/support" className="text-amber-500 hover:text-amber-400">RSPlatform Terms</Link> and agree to the terms and conditions.
                </label>
              </div>
          ...
          <p className="text-center text-[10px] font-black text-zinc-600 uppercase tracking-widest">
            Already have an account? <Link href="/login" className="text-amber-500 hover:text-amber-400">Log In</Link>
          </p>
