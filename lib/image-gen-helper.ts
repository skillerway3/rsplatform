...
// This is a helper script to be run once or used to get the strings
// Since I am the agent, I will execute the generation logic internally and then update the code.
